...
struct Constants {
    ...
    struct Watch {
        struct Main {
            static let Title = "Zmanim"
            struct Context {
                static let Tefillah = "tefillah"
                static let Zmanim = "zmanim"
            }
        }
    ...
    struct Storyboard {
        ...
        struct Watch {
            struct Main {
                static let TextRowControllerIdentifier = "Text Row Controller"
                static let ZmanimInterfaceController = "Zmanim Interface Controller"
            }
            
            struct Zmanim {
                static let TextSubtitleRowControllerIdentifier = "Text Subtitle Row Controller"
                static let LocationInterfaceControllerIdentifier = "Location Interface Controller"
            }
        }
    }
    ...
    struct Alerts {
        ...
        struct Watch {
            struct Selection {
                static let Message = "Please select a location..."
            }
            
            struct Shabbos {
                static let Title = "Shabbos"
                static let Message = "Shabbos zmanim are available in the \"More\" section on your iPhone."
            }
        }
    ...
    struct Notifications {
        struct ZmanReminder {
            static let Title = "Zman Reminder"
        }
    }
    ...
    struct URLs {
        ...
        struct YUZmanimAPI {
            static let Tefillos = "http://yuzmanim.com/api/tefillos.json"
            static let Locations = "http://yuzmanim.com/api/locations.json"
            static let Shabbos = "http://yuzmanim.com/api/shabbos.json"
            static let DaySelichos = "http://www.yuzmanim.com/api/selichos.json"
            static let NightSelichos = "http://www.yuzmanim.com/api/night_selichos.json"
        }
